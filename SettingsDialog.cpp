...
SettingsDialog::SettingsDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticText3 = new wxStaticText(PanelGeneral, ID_STATICTEXT3, _("#Years of Observation:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
	FlexGridSizer2->Add(StaticText3, 1, wxALL|wxEXPAND, 5);
	SpinCtrlObYears = new wxSpinCtrl(PanelGeneral, ID_SPINCTRL1, _T("30"), wxDefaultPosition, wxDefaultSize, 0, 20, 50, 30, _T("ID_SPINCTRL1"));
	SpinCtrlObYears->SetValue(_T("30"));
	FlexGridSizer2->Add(SpinCtrlObYears, 1, wxALL|wxEXPAND, 5);
	ButtonResetObYears = new wxButton(PanelGeneral, ID_BUTTON5, _("Reset"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON5"));
	FlexGridSizer2->Add(ButtonResetObYears, 1, wxALL|wxEXPAND, 5);
	...
	Connect(ID_SPINCTRL1,wxEVT_COMMAND_SPINCTRL_UPDATED,(wxObjectEventFunction)&SettingsDialog::OnSpinCtrlObYearsChange);
	Connect(ID_BUTTON5,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&SettingsDialog::OnButtonResetObYearsClick);
	...
	SpinCtrlObYears->SetValue(config.getObYears());
...
void SettingsDialog::OnButtonResetObYearsClick(wxCommandEvent& event)
{
    SpinCtrlObYears->SetValue(30);
}
...
void SettingsDialog::OnButtonOKClick(wxCommandEvent& event)
{
    ...
    config.setObYears(SpinCtrlObYears->GetValue());
